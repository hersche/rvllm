...
__global__ void fused_rope_partial_nvfp4kv_kernel(
    ...
    // E4B kv-share fast-path: see fused_rope_partial_fp8kv.cu for
    // the contract. Host passes key_cache=value_cache=nullptr for
    // layers that alias an earlier source layer's K/V cache.
