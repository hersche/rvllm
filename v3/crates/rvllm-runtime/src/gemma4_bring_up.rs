...
pub struct Gemma4Bringup {
    ...
    /// Stream-7: Gemma 4 ViT kernel subset, shared with
    /// `Gemma4Nvfp4Bringup` via the [`crate::gemma4_vision::
    /// Gemma4VisionRuntime`] view. Loaded once at startup; the
...
impl Gemma4Bringup {
    ...
    pub fn forward_gemma_vision(
        ...
        // Stream-7: body lives in `gemma4_vision::Gemma4VisionRuntime`.
